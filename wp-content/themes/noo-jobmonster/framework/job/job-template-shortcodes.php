	...
	function jm_noo_job_search_shortcode( $atts, $content = null ) {
        ...
        <div
			...
			if ( $background_type == 'revo_slider' ) : ?>
                ...
                <div
                    class="job-advanced-search container <?php echo( $search_mode == 'noo_vertical' ? ' vertical' : ' horizontal ' . $style_horizontal ); ?> column-<?php echo esc_attr( $fields_count ); ?>" <?php if ( ! empty( $search_position ) ) {
                    ...
                    <?php if ( $sub_title != '' ): ?>
                        <div class="job-search-info <?php echo $align_title ?>">
                            <p class="search-sub-title-bottom"
                               style="color: <?php echo $title_color ?>"><?php echo $sub_title; ?></p>
                        </div>
					<?php endif ?>
                </div>
			...
			?>
			<?php endif; ?>
                <div class="job-advanced-search container <?php echo( $search_mode == 'noo_vertical' ? ' vertical' : ' horizontal ' . $style_horizontal ); ?> column-<?php echo esc_attr( $fields_count ); ?>" <?php if ( ! empty( $search_position ) ) {
					echo 'style="top: ' . absint( $search_position ) . 'px;"';
				} ?>>
                    <div class="job-search-info <?php echo $align_title ?>">
						<?php if ( ! empty( $title ) ) : ?>
...
//		}
        ...
        <div class="<?php echo $class; ?>">
            <span class="noo-icon-register" style="<?php echo $custom_icon; ?>"><i
                        class="fa <?php echo $icon ?>"></i></span>
            <h4 class="register-title"><?php echo esc_html( $title ); ?></h4>
...
if ( ! function_exists( 'noo_list_job_category_shortcode' ) ) :
	function noo_list_job_category_shortcode( $atts, $content = null ) {
        ...
        <div<?php echo( $id . $class . $custom_style ); ?>>
			...
			<?php endif; ?>
            <div
                    class="noo-list-job-category-content noo-list-job-category-col-<?php echo esc_attr( $list_column ) . ' ' . $style_job_category; ?>">
                <ul>
					<?php
					$i = 0;
