...
if ( ! function_exists( 'noo_customizer_register_options_job' ) ) :
	function noo_customizer_register_options_job( $wp_customize ) {
		...
		$helper->add_control(
			...
			'noo_radio',
			__( 'Job List Display Default Type', 'noo' ),
			'list',
			array(
				'choices' => array(
					'grid'      => __( 'Grid', 'noo' ),
		...
		// Control: Job List Style
		$helper->add_control(
			'noo_jobs_list_style',
			'noo_radio',
			__( 'Job List Style', 'noo' ),
			'',
			array(
				'choices' => array(
					''      => __( 'Type List Style 1', 'noo' ),
					'two' => __( 'Type List Style 2', 'noo' ),
				)
			),
			array( 'transport' => 'postMessage' )
		);

		// Control: Job List Pagination Style
		$helper->add_control(
			'noo_jobs_list_pagination_style',
			'noo_radio',
			__( 'Job List Pagination Style', 'noo' ),
			'',
			array(
				'choices' => array(
					'' => __( 'Page Numbers', 'noo' ),
		...
		$helper->add_sub_section(
			...
			__( 'Choose Layout settings for your Companies List', 'noo' )
		);

		// Control: Companies List Layout
		$helper->add_control(
			'noo_companies_layout',
			'noo_radio',
			__( 'Companies List Layout', 'noo' ),
			'fullwidth',
			array(
				'choices' => array(
					'fullwidth'   => __( 'Full-Width', 'noo' ),
		...
		// Control: Companies List Style
		$helper->add_control(
			'noo_companies_style',
			'noo_radio',
			__( 'Companies List Style', 'noo' ),
			'',
			array(
				'choices' => array(
		...
		$helper->add_control(
			...
			array(
				'choices' => array(
					''      => __( 'Sidebar Information', 'noo' ),
					'two' => __( 'Full Information', 'noo' ),
				),
				'json' => array(
					'child_options' => array(
						''   => '',
...
if ( ! function_exists( 'noo_customizer_register_options_resume' ) ) :
	function noo_customizer_register_options_resume( $wp_customize ) {
		...
		// Control: Resume Listing Display type
		$helper->add_control(
			'noo_resume_display_type',
			'noo_radio',
			__( 'Resume List Display Default Type', 'noo' ),
			'list',
			array(
				'choices' => array(
					'grid'      => __( 'Grid', 'noo' ),
		...
		// Control: Resume Detail Layout
		$helper->add_control(
			'noo_resumes_detail_layout',
			'noo_radio',
			__( 'Resume Detail Layout', 'noo' ),
			'style-1',
			array(
				'choices' => array(
					'style-1'   => __( 'Style 1', 'noo' ),
