...
if ( ! function_exists( 'noo_job_category_shortcode' ) ) :
	function noo_job_category_shortcode( $atts, $content = null ) {
		...
		include 'job-category/' . $style . '.php';

		return ob_get_clean();
	}

	add_shortcode( 'noo_job_category', 'noo_job_category_shortcode' );
