		...
		<div class="form-group row">
			<div class="col-sm-9">
				<div class="form-control-flat">
					<label class="radio" for="<?php echo $prefix; ?>_user_role_1" ><input id="<?php echo $prefix; ?>_user_role_1" type="radio" name="user_role" value="employer" checked=""><i></i><?php echo esc_html__('I\'m an employer looking to hire','noo')?></label>
					<label class="radio" for="<?php echo $prefix; ?>_user_role_2" ><input id="<?php echo $prefix; ?>_user_role_2" type="radio" name="user_role" value="candidate" checked=""><i></i><?php echo esc_html__('I\'m a candidate looking for a job','noo')?></label>
				</div>
			</div>
		</div>
