			...
			<div class="noo-dashboard-table">
				<table class="table noo-datatable" id="noo-table-job-applied">
					...
					<tr>
                        ...
                        <th class="hidden-xs"> <?php _e('Company ') ?></th>
						...
						while ( $r->have_posts() ): $r->the_post();
							...
							<tr>
									...
									<div class="loop-item-wrap">
										...
										if ( $job && $job->post_type === 'noo_job' ) :
											...
											<div class="loop-item-content">
												<strong><a
														href="<?php echo get_permalink( $job->ID ); ?>"><?php echo esc_html( $job->post_title ); ?></a><strong>
											</div>
											<?php
										else :
								...
								<td class="text-center" data-filter="<?php echo esc_attr($status_class); ?>">
									<span
										class="jm-status jm-status-<?php echo sanitize_html_class( $status_class ) ?>">
								...
								<td class="member-manage-actions hidden-xs text-center">
									...
									<?php if ( $post->post_status == 'pending' ) : ?>
										<a href="<?php echo wp_nonce_url( add_query_arg( array(
										   ...
										   title="<?php esc_attr_e( 'Withdraw', 'noo' ) ?>"><i
