...
<?php else: ?>
    ...
    <div class="member-manage">
        <?php if ( $r->found_posts ) : ?>
            <h3><?php echo sprintf( _n( "You've received %s Job following", "You've received %s Jobs following", $r->found_posts, 'noo' ), $r->found_posts ); ?></h3>
        <?php else : ?>
                        ...
                        <tr>
                            ...
                            <td class="company-actions">
                                <a href="<?php the_permalink() ?>">
                                    <?php echo esc_html__( 'View Now', 'noo' ) ?>
                                </a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
