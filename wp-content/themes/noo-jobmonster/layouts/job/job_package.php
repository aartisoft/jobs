...
<div class="job-package clearfix">
    ...
    <?php if ($packages): ?>
        ...
        <div class="noo-pricing-table classic row package-pricing noo-col-<?php echo $columns; ?> <?php echo $package_style; ?>">
            <?php foreach ($packages as $package): ?>
                ...
                <div class="<?php echo $product->get_slug(); ?> noo-pricing-column <?php echo 'col-sm-6 col-md-' . $columns_class; ?> <?php echo($product->is_featured() ? 'featured' : ''); ?>">
                    <div class="pricing-content">
                        ...
                        <div class="pricing-info">
                            <ul class="noo-ul-icon fa-ul">
                                ...
                                <?php if ($is_unlimited || $job_limit > 0) : ?>
                                    <li class="noo-li-icon"><i
                                                class="fa fa-check-circle"></i> <?php echo $job_posting_text; ?></li>
                                <?php else : ?>
                                    <li class="noo-li-icon"><i
                                ...
                                <?php if ($featured_limit > 0) : ?>
                                    <li class="noo-li-icon"><i
                                                class="fa fa-check-circle"></i> <?php echo $job_featured_text; ?></li>
                                <?php else : ?>
                                    <li class="noo-li-icon"><i
                                ...
                                <?php if ($refresh_limit > 0) : ?>
                                    <li class="noo-li-icon"><i
                                                class="fa fa-check-circle"></i> <?php echo $job_refresh_text; ?></li>
                                <?php else : ?>
                                    <li class="noo-li-icon"><i
                                                class="fa fa-times-circle-o not-good"></i> <?php echo __('No refresh job', 'noo'); ?>
                                    </li>
                                <?php endif; ?>
                                <?php if ($is_unlimited || $job_limit > 0) : ?>
                                    <li class="noo-li-icon"><i
                                                class="fa fa-check-circle"></i> <?php echo $job_duration_text; ?></li>
                                <?php endif; ?>
                            ...
                            <?php else : ?>
                                <div class="pricing-footer" data-toggle="tooltip"
                                    ...
                                    <a style="pointer-events: none;"
                                       class="btn btn-lg btn-primary  btn-primary-disabled <?php echo $disable ?> <?php echo ($product->get_price() == 0 && is_user_logged_in()) ? ' auto_create_order_free' : ''; ?>"
                        ...
                        <?php } ?>
                        <?php if (!empty($package->post_content)) : ?>
                            <div id="package-content-<?php echo $package->ID; ?>" class="package-content modal fade"
                                 tabindex="-1" role="dialog"
                                 aria-labelledby="package-content-<?php echo $package->ID; ?>Label" aria-hidden="true">
